...
def gen_round_rpc_unix():
    ...
    ruta_base_rpc = r"/home/josuerom/Workspace/Competitive-Programming/Contests/RPC"
    ...
    path_templates = Path("/home/josuerom/Workspace/Competitive-Programming/Templates")
