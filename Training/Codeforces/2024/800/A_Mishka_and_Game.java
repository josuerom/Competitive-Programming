...
public class A_Mishka_and_Game {
   public static void main(String[] args) {
      ...
      int tt = fr.readInt(), mishka = 0, chris = 0;
      while (tt-- > 0) {
         int m = fr.readInt();
         int c = fr.readInt();
         if (m > c) mishka++;
      ...
      if (mishka == chris) pw.println("Friendship is magic!^^");
      else if (mishka > chris) pw.println("Mishka");
      else pw.println("Chris");
      pw.flush(); pw.close();
   }
